...
public class BarangControllerStatic {
    ...
    public String indeks(Model model) {
        model.addAttribute("title", "Barang Perusahaan ABC");
        return "index";
    }
    @GetMapping(value = "/list")
    public String getBarang(Model model,
                              @RequestParam(value = "page", defaultValue = "1") int pageNumber) {
        List<Barang> barangs = barangServiceStatic.dataBrg(pageNumber, ROW_PER_PAGE);
    ...
    public String addBarang(Model model,
        ...
        try {
            System.out.println("nilai barang = " + barang.getNama());
